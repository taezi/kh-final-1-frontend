...
      <h1 className="cv-title center">{data.restName} {data.restBranch} 
         <button
        className={`hearts editor-detail-hearts ${likes.has(data.restNo) ? "is-on" : ""}`}
        onClick={(e) => {
          e.stopPropagation(); // 카드 클릭 이벤트와 겹치지 않도록
          toggleLike(data.restNo, e); // data.cafeNo를 인자로 전달
        }}
        title="좋아요"
      >
        ♡
