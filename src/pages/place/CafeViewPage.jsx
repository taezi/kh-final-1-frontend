...
  const imgs = useMemo(() => {
    const thumbUrl = cafe?.cafeImgAddress || "https://picsum.photos/1200/800?blur=2";
    return [thumbUrl];
  }, [cafe]);
...
      <h1 className="cv-title center">{cafe.cafeName} {cafe.cafeBranch} 
         <button
        className={`hearts editor-detail-hearts ${likes.has(cafe.cafeNo) ? "is-on" : ""}`}
        onClick={(e) => {
