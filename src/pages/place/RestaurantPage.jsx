...
export default function RestPage() {
  ...
  const toggleLike = (restNo) =>
    setLikes((prev) => {
      const n = new Set(prev);
      n.has(restNo) ? n.delete(restNo) : n.add(restNo);
      return n;
    });
        ...
        <div className="ev-grid">
          ...
          {items.map((rest) => (
            <article
              ...
              className="ev-card"
              onClick={() =>
                navigate(`/restaurants/${rest.restName}/${rest.restBranch}`, { state: rest })
              }state={{ restDetail: rest }}
